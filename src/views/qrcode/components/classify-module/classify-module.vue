...
<template>
  <popup-modal :block="block" @on-close="onClose">
    <a href="javascript:;" class="module-title">嵌套模块操作教程</a>
    ...
    <div slot="footer">
      <div class="module-group clearfix">
        ...
        <div class="module-control-content">
          <Button size="large" class="edit-content-btn" @click="editClassifyModule">编辑嵌套内容</Button>
          ...
          query: {
            ...
            parentTemplateId: (() => {
              if (this.$route.query.parentTemplateId) {
                let a = JSON.parse(this.$route.query.parentTemplateId);
                a.push(this.$route.query.templateId);
            ...
            templateId: this.currentModule.moduleObject.templateId,
            mobUrl: this.$route.query.mobUrl,
            pcUrl: this.$route.query.pcUrl,
            parentClassifyName: (() => {
              if (this.$route.query.parentClassifyName) {
                let a = JSON.parse(this.$route.query.parentClassifyName);
                a.push(this.$route.query.classifyName);
                return JSON.stringify(a);
              } else {
                let a = [];
                return JSON.stringify(a);
            ...
            classifyName: this.block.moduleTitle,
            templateType: 2
          }
        })
      },
      ...
      target.moduleVOJson = (() => {
        let options = {
          ...
          moduleObject: {
            ...
            templateId: this.tis.$Global.isBlank(this.tis.templateId) ? '' : this.tis.templateId,
            image: {
